...
--
-- Name: einstaklingur_logheimili_heimilisfang; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.einstaklingur_logheimili_heimilisfang (
    "einstaklingurKennitala" character varying(12) NOT NULL,
    "heimilisfangId" integer NOT NULL
);


ALTER TABLE public.einstaklingur_logheimili_heimilisfang OWNER TO postgres;
...
--
-- Name: einstaklingur_logheimili_heimilisfang einstaklingur_logheimili_heimilisfang_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.einstaklingur_logheimili_heimilisfang
    ADD CONSTRAINT einstaklingur_logheimili_heimilisfang_pkey PRIMARY KEY ("einstaklingurKennitala", "heimilisfangId");


--
-- Name: einstaklingur_logheimili_heimilisfang einstaklingur_logheimili_heimilisfang_ideinstaklings_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.einstaklingur_logheimili_heimilisfang
    ADD CONSTRAINT einstaklingur_logheimili_heimilisfang_ideinstaklings_fkey FOREIGN KEY ("einstaklingurKennitala") REFERENCES public.einstaklingar(kennitala);


--
-- Name: einstaklingur_logheimili_heimilisfang einstaklingur_logheimili_heimilisfang_idheimili_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.einstaklingur_logheimili_heimilisfang
    ADD CONSTRAINT einstaklingur_logheimili_heimilisfang_idheimili_fkey FOREIGN KEY ("heimilisfangId") REFERENCES public.heimilisfong(id);
